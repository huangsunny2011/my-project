...
"@
    ...
    $readmeContent | Out-File -FilePath (Join-Path $CategoryPath "README.md") -Encoding utf8
...
$newDiscussionScript | Out-File -FilePath (Join-Path $ProjectPath "new-discussion.ps1") -Encoding utf8
...
$searchScript | Out-File -FilePath (Join-Path $ProjectPath "search-discussion.ps1") -Encoding utf8
...
$statsScript | Out-File -FilePath (Join-Path $ProjectPath "stats.ps1") -Encoding utf8
